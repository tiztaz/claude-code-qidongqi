# 在苹果 macOS 系统上免安装地使用 Claude Code

这篇图文说明教您在 苹果 macOS 系统的电脑上，如何通过简单的操作下载和使用 [Claude Code 启动器](https://www.claudezip.cn?utm_source=github&utm_medium=article&utm_campaign=claude-code-qidongqi)。

## [Claude Code 启动器](https://www.claudezip.cn?utm_source=github&utm_medium=article&utm_campaign=claude-code-qidongqi)的系统要求

- **系统**: macOS 10.13 (High Sierra) 或更高版本 (Intel / Apple Silicon 都支持)
- **内存**: 至少 4GB
- **存储**: 至少 1GB 可用空间
- **网络**: 可以访问互联网
...
![打开您的电脑的网络浏览器，点击网址框，输入网址： `claudezip.cn`  然后按回车。](images/mac-install-step-01.jpg)
...
![按下载运行按钮，下载 Claude Code 启动器。](images/mac-install-step-02.jpg)

**第三步：** 下载好后，点击运行 Claude Code。
![下载好后，在电脑的下载目录中，用鼠标双击运行 ClaudeCode.zip 文件，安装 Claude Code。](images/mac-install-step-03.jpg)

**安装完成** 这样就可以使用 Claude Code 了。
![安装完成，这样就可以使用 Claude Code 了。](images/mac-install-step-04.jpg)
